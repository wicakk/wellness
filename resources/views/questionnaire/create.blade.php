        ...
        <div class="flex justify-between gap-4">
            ...
            <button type="submit"
                ...
                {!! isset($questionnaire)
                    ...
                    : '<svg class="w-4 h-4 inline flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Buat Kuesioner' !!}
            </button>
        </div>
    </form>
</div>
...
@push('scripts')
@php
$existingThresholds = isset($questionnaire)
    ? $questionnaire->riskThresholds->map(fn($t) => [
        'id'          => $t->id,
        'level'       => $t->level,
        'label'       => ucfirst($t->level),
