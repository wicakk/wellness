...
<style>
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .wrap{
    width:100%;max-width:1060px;display:flex;border-radius:28px;overflow:hidden;
    box-shadow:0 24px 80px rgba(0,0,0,.14);min-height:620px;
  }
  .panel-left{
    width:38%;flex-shrink:0;
    background:linear-gradient(160deg,#064e3b 0%,#065f46 40%,#047857 100%);
    display:flex;flex-direction:column;justify-content:space-between;padding:36px 32px;
  }
  ...
  .panel-headline{font-family:'Playfair Display',serif;color:#fff;font-size:36px;line-height:1.2;margin-bottom:12px;}
  ...
  .stat{flex:1;text-align:center;padding:12px 6px;background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.18);border-radius:14px;}
  .stat-num{color:#fff;font-weight:800;font-size:20px;}
  .stat-lbl{color:#6ee7b7;font-size:10px;margin-top:2px;font-weight:500;}
  .panel-right{flex:1;background:rgba(255,255,255,.94);backdrop-filter:blur(24px);display:flex;flex-direction:column;overflow:hidden;}
  .tab-nav{display:flex;border-bottom:1.5px solid #e5e7eb;background:#fff;flex-shrink:0;}
  .tab-btn{
    flex:1;padding:18px 12px;font-size:13px;font-weight:600;cursor:pointer;border:none;
    background:transparent;color:#9ca3af;position:relative;transition:color .2s;
  ...
  .panel-body{flex:1;overflow-y:auto;padding:28px 36px;}
  .view{display:none;}
  ...
  .req{color:#ef4444;}
  .opt{background:#f1f5f9;color:#94a3b8;font-size:9px;font-weight:700;padding:2px 6px;border-radius:4px;letter-spacing:.5px;text-transform:uppercase;margin-left:6px;}
  ...
  .inp{
    ...
    font-size:13.5px;color:#0f172a;outline:none;transition:all .22s;
  }
  ...
  .inp.is-invalid{border-color:#ef4444;}
  select.inp{
  ...
  .rc-dot{width:16px;height:16px;border-radius:50%;border:2px solid #cbd5e1;flex-shrink:0;display:flex;align-items:center;justify-content:center;transition:all .15s;}
  ...
  .chk-box{width:16px;height:16px;border:2px solid #d1d5db;border-radius:4px;background:#fff;transition:all .15s;display:flex;align-items:center;justify-content:center;}
  .chk-wrap input:checked ~ .chk-box{background:#10b981;border-color:#10b981;}
  .chk-wrap input:checked ~ .chk-box::after{content:'';display:block;width:9px;height:6px;border-left:2px solid #fff;border-bottom:2px solid #fff;transform:rotate(-45deg) translate(1px,-1px);}
  ...
  .demo-card{
    ...
    cursor:pointer;transition:all .18s;text-align:left;font-family:'Plus Jakarta Sans',sans-serif;
  }
  ...
  .sec{border:1px solid #f1f5f9;border-radius:16px;padding:20px;margin-bottom:16px;background:#fff;}
  ...
  .btn-outline{
    ...
    background:#fff;color:#64748b;font-family:'Plus Jakarta Sans',sans-serif;font-size:13px;font-weight:600;transition:all .2s;
  }
...
<div class="wrap">
  ...
  <div class="panel-right">
    ...
    <div class="panel-body view" id="view-login">
      ...
      @if (session('status'))
        <div style="background:#f0fdf4;border:1px solid #bbf7d0;color:#16a34a;padding:12px 16px;border-radius:12px;margin-bottom:20px;font-size:13px;">
          {{ session('status') }}
        </div>
      @endif
        ...
        <div class="field">
          ...
          <div class="inp-wrap">
            ...
            <input type="email" name="email" value="{{ old('email') }}"
              ...
              placeholder="nama@instansi.id" autocomplete="username" autofocus>
          </div>
        ...
        <div class="field">
          ...
          <div class="inp-wrap">
            ...
            <button type="button" onclick="togglePwd('loginPwd','eyeLogin')" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:#9ca3af;padding:4px;">
              <svg id="eyeLogin" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="sec">
          <div class="sec-hdr">
            ...
            <div><div class="sec-title">Informasi Dasar</div><div class="sec-sub">Identitas dan posisi di organisasi</div></div>
          </div>
            ...
            <div class="field col-2">
              ...
              <div class="inp-wrap">
                ...
                <input type="text" name="phone" value="{{ old('phone') }}"
                  class="inp has-icon" placeholder="08xxxxxxxxxx">
              </div>
            </div>
        ...
        <div class="sec">
          <div class="sec-hdr">
            ...
            <div><div class="sec-title">Data Personal</div><div class="sec-sub">Informasi demografis pegawai</div></div>
          </div>
            ...
            <div class="radio-group">
              ...
              <label class="rc">
                <input type="radio" name="has_health_issue" value="0"
                  {{ old('has_health_issue', '0') != '1' ? 'checked' : '' }}
        ...
        <div class="sec">
          <div class="sec-hdr">
            ...
            <div><div class="sec-title">Password Akun</div><div class="sec-sub">Buat password yang aman</div></div>
          </div>
          ...
          <div class="grid-2">
            <div class="field">
              ...
              <div class="pwd-bars">
                <div class="pwd-bar" id="rb1"></div><div class="pwd-bar" id="rb2"></div>
                <div class="pwd-bar" id="rb3"></div><div class="pwd-bar" id="rb4"></div>
              </div>
        ...
        <div class="reg-actions">
          <button type="button" class="btn-outline" onclick="switchTab('login')">Batal</button>
