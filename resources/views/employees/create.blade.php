...
<main class="main">
  ...
  {{-- ── FORM (action, method, csrf semuanya sudah benar) ── --}}
  <form id="emp-form"
        ...
        <div class="field col-span-2">
          ...
          @error('name')
            <span class="error-msg">
              <svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" d="M12 8v4m0 4h.01"/></svg>
              {{ $message }}
            </span>
          @enderror
        </div>
    ...
    <div class="card">
      ...
      <div style="display:flex;flex-direction:column;gap:18px;">
        ...
        <div class="grid-2">
          ...
          <!-- Pendidikan — value harus cocok dengan validasi controller -->
          <div class="field">
            ...
            <select name="pendidikan" class="inp @error('pendidikan') is-invalid @enderror">
              ...
              <option value="Profesi" {{ old('pendidikan') === 'Profesi'  ? 'selected' : '' }}>Profesi (Ners / Dokter / Apoteker)</option>
    ...
    <div class="card">
      ...
      <div id="health-detail" class="{{ old('has_health_issue') == '1' ? 'show' : '' }}">
        <div class="field">
          ...
          <textarea name="health_issue_detail"
                    ...
                    rows="3"
                    placeholder="Contoh: Hipertensi, Diabetes Melitus Tipe 2, Asma…">{{ old('health_issue_detail') }}</textarea>
